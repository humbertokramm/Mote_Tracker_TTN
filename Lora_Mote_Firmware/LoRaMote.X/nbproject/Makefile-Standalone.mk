...
dist/${CND_CONF}/${IMAGE_TYPE}/LoRaMote.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/LoRaMote.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=icd3  --double=32 --float=32 --emi=wordwrite --opt=+asm,-asmfile,+speed,-space,+debug,-local --addrqual=ignore --mode=pro -P -N255 -I"../Includes/MccGenerated" -I"../Includes/Drivers" -I"../Includes/Board" -I"../Includes/Usb" -I"../Includes/Usb/Framework" --warn=0 --asmlist -DXPRJ_Standalone=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/LoRaMote.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
